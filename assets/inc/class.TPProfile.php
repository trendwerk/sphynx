				...
				<tr>
					...
					<td>
						<a href="http://gravatar.com/" target="_blank" style="float: left; margin-right: 10px;" >
							<?php echo get_avatar( $user->data->user_email, $size = '50' ); ?>
						</a>
						<span class="description"><?php _e('You can change your profile picture via','tp'); ?> <a href="http://gravatar.com/" target="_blank">Gravatar.com</a> <?php _e('by logging in or signing up for free with the email address associated with your profile','tp'); ?> (<?php echo $user->data->user_email; ?>).
						</span>
					</td>
				</tr>
			</tbody>
