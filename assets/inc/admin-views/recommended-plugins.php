<div class="wrap">
	...
	<p><?php _e('On this page, you can install plugins recommended by Trendwerk and apply recommended settings to them after installing.','tp'); ?></p>
	...
	<h3><?php _e('Developer tools','tp'); ?></h3>
