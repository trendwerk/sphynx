<div class="wrap trendpress-options">
	...
	<form method="post" action="<?php echo admin_url('themes.php?page=tp-contact_info'); ?>">
		<fieldset>
			...
			<p><label for="naam"><?php _e('Company name','tp'); ?></label> <input name="naam" id="naam" type="text" value="<?php echo get_option('tp-naam'); ?>"/></p>
			<p><label for="adres"><?php _e('Adress','tp'); ?></label> <input name="adres" id="adres" type="text" value="<?php echo get_option('tp-adres'); ?>"/></p>
			...
			<p><label for="fax"><?php _e('Fax','tp'); ?></label> <input name="fax" id="fax" type="text" value="<?php echo get_option('tp-fax'); ?>"/></p>
			<br />
			...
			<p><label for="bank"><?php _e('Bank name','tp'); ?></label> <input name="bank" id="bank" type="text" value="<?php echo get_option('tp-bank'); ?>"/></p>
			...
			<br />
			<p><label for="twitter">Twitter URL</label> <input name="twitter" id="twitter" type="text" value="<?php echo get_option('tp-twitter'); ?>"/></p>
			<p><label for="facebook">Facebook URL</label> <input name="facebook" id="facebook" type="text" value="<?php echo get_option('tp-facebook'); ?>"/></p>
			<p><label for="linkedin">Linkedin URL</label> <input name="linkedin" id="linkedin" type="text" value="<?php echo get_option('tp-linkedin'); ?>"/></p>
			<p><label for="googleplus">Google Plus URL</label> <input name="googleplus" id="googleplus" type="text" value="<?php echo get_option('tp-googleplus'); ?>"/></p>
			<p><label for="youtube">YouTube URL</label> <input name="youtube" id="youtube" type="text" value="<?php echo get_option('tp-youtube'); ?>"/></p>
			<br />
