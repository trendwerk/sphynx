 ...
 */
function tp_theme_options_add_page() {
	add_theme_page(__('Theme options','tp'),__('Theme options','tp'),'publish_pages','tp-theme-option','tp_theme_options_do_page');
} 
add_action('admin_menu','tp_theme_options_add_page');


/**
 * Add the back-end admin view
 */
function tp_theme_options_do_page() {
	tp_save_theme_options();
