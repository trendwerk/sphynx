...
class TP_Contact_Information {
	...
	function add_settings() {
		...
		add_settings_field( 'tp-sitename', __( 'Sitename', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-general', array(
		...
		add_settings_field( 'tp-description', __( 'Description', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-general', array(
		...
		add_settings_field( 'tp-company-name', __('Company name','tp'), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-company-name',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-company-name' );
		
		add_settings_field( 'tp-address', __( 'Address', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-address',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-address' );
		
		add_settings_field( 'tp-postal-code', __( 'Postal code' , 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-postal-code',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-postal-code' );
		
		add_settings_field( 'tp-city', __( 'City', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-city',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-city' );
		
		add_settings_field( 'tp-country', __( 'Country', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-country',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-country' );
		
		add_settings_field( 'tp-email', __( 'E-mail', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-email',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-email' );
		
		add_settings_field( 'tp-telephone', __( 'Telephone', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-telephone',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-telephone' );
		
		add_settings_field( 'tp-fax', __( 'Fax', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-contact', array(
			'label_for' => 'tp-fax',
			'class' => 'regular-text',
		) );
		...
		add_settings_field( 'tp-cc', __( 'CC No.', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-registration', array(
			'label_for' => 'tp-cc',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-cc' );
		
		add_settings_field( 'tp-vat', __( 'VAT No.', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-registration', array(
			'label_for' => 'tp-vat',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-vat' );
		
		add_settings_field( 'tp-bank', __( 'Bank name', 'tp'), array( $this, 'show_text_field' ), 'tp-information', 'tp-registration', array(
			'label_for' => 'tp-bank',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-bank' );
		
		add_settings_field( 'tp-bank-no', __( 'Bank No.', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-registration', array(
		...
		add_settings_field( 'tp-twitter', __( 'Twitter URL', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
			'label_for' => 'tp-twitter',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-twitter', 'tp_maybe_add_http' );
		
		add_settings_field( 'tp-facebook', __( 'Facebook URL', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
			'label_for' => 'tp-facebook',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-facebook', 'tp_maybe_add_http' );
		
		add_settings_field( 'tp-linkedin', __( 'LinkedIn URL', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
			'label_for' => 'tp-linkedin',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-linkedin', 'tp_maybe_add_http');
		
		add_settings_field( 'tp-googleplus', __( 'Google Plus URL', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
			'label_for' => 'tp-googleplus',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-googleplus', 'tp_maybe_add_http' );
		
		add_settings_field( 'tp-youtube', __( 'YouTube URL', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
			'label_for' => 'tp-youtube',
			'class' => 'regular-text',
		) );
		register_setting( 'tp-information', 'tp-youtube', 'tp_maybe_add_http' );
		
		add_settings_field( 'tp-newsletter', __( 'Newsletter / mailto link', 'tp' ), array( $this, 'show_text_field' ), 'tp-information', 'tp-social', array(
		...
		add_settings_field( 'tp-rss', '', array( $this, 'show_checkbox' ), 'tp-information', 'tp-social', array(
			'label' => __( 'Show RSS feed in the social media widget', 'tp' ),
			'option_key' => 'tp-rss',
		) );
	 ...
	 */
	function add_menu() {
		add_theme_page( __( 'Contact information', 'tp' ), __( 'Contact information', 'tp' ), $this->get_capability(), 'tp-information', array( $this, 'display' ) );
	}
