...
jQuery(document).ready(function($){
	...
	/*	check if there's an image with a link wrapped around
		it. if so, give it the class .fancybox so that we 
		can open the image with fancybox */
	
	$('section#main .inner a').has('img').addClass('fancybox');
